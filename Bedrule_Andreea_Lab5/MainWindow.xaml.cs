...
namespace Bedrule_Andreea_Lab5
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var queryOrder = from ord in ctx.Orders join cust in ctx.Customers on ord.CustId equals cust.CustId  join inv in ctx.Inventories on ord.CarId equals inv.CarId
                             select new
                             {
                                 ord.OrderId,
                                 ord.CarId,
